      ...
      return knex('projects').insert([
        {
          ...
          tech_stack: JSON.stringify(['React', 'Redux']) ,
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Ruby', 'Rails', 'WebSockets', 'Active Record', 'PostgreSQL', 'Bootstrap', 'SASS']) ,
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Express', 'Node', 'React', 'WebSockets']) ,
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Ruby', 'Rails', 'Bootstrap', 'RSpec']) ,
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Express', 'Node', 'jQuery', 'PostgreSQL', 'Bootstrap', 'SASS']) ,
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Express', 'Node', 'jQuery', 'MongoDB']),
        ...
        },
        {
          ...
          tech_stack: JSON.stringify(['Express', 'Node']) ,
